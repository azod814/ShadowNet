...
def download_asset(
    ...
    try:
        ...
        # IMPORTANT:
        # Absolute local route for browser preview
        local_url = (
...
def preview_page(
    ...
    # Extra protection against empty IDs
